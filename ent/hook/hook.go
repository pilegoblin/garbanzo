...
// The BeanFunc type is an adapter to allow the use of ordinary
// function as Bean mutator.
type BeanFunc func(context.Context, *ent.BeanMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BeanFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BeanMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BeanMutation", m)
}
