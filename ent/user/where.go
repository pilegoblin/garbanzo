...
// HasOwnedPods applies the HasEdge predicate on the "owned_pods" edge.
func HasOwnedPods() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOwnedPodsWith applies the HasEdge predicate on the "owned_pods" edge with a given conditions (other predicates).
func HasOwnedPodsWith(preds ...predicate.Pod) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOwnedPodsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasJoinedPods applies the HasEdge predicate on the "joined_pods" edge.
func HasJoinedPods() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasJoinedPodsWith applies the HasEdge predicate on the "joined_pods" edge with a given conditions (other predicates).
func HasJoinedPodsWith(preds ...predicate.Pod) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newJoinedPodsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
