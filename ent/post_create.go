...
func (pc *PostCreate) SetBeanID(id int) *PostCreate {
	pc.mutation.SetBeanID(id)
	return pc
}

// SetNillableBeanID sets the "bean" edge to the Bean entity by ID if the given value is not nil.
func (pc *PostCreate) SetNillableBeanID(id *int) *PostCreate {
	if id != nil {
		pc = pc.SetBeanID(*id)
	}
	return pc
...
func (pc *PostCreate) SetBean(b *Bean) *PostCreate {
	return pc.SetBeanID(b.ID)
}
...
func (pc *PostCreate) createSpec() (*Post, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.BeanIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
