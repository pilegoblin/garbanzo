...
func (pu *PostUpdate) SetBeanID(id int) *PostUpdate {
	pu.mutation.SetBeanID(id)
	return pu
}

// SetNillableBeanID sets the "bean" edge to the Bean entity by ID if the given value is not nil.
func (pu *PostUpdate) SetNillableBeanID(id *int) *PostUpdate {
	if id != nil {
		pu = pu.SetBeanID(*id)
	}
	return pu
...
// SetBean sets the "bean" edge to the Bean entity.
func (pu *PostUpdate) SetBean(b *Bean) *PostUpdate {
	return pu.SetBeanID(b.ID)
}
...
func (pu *PostUpdate) ClearBean() *PostUpdate {
	pu.mutation.ClearBean()
	return pu
}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.BeanCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.BeanTable,
			Columns: []string{post.BeanColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := pu.mutation.BeanIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.BeanTable,
...
// SetBeanID sets the "bean" edge to the Bean entity by ID.
func (puo *PostUpdateOne) SetBeanID(id int) *PostUpdateOne {
	puo.mutation.SetBeanID(id)
	return puo
}

// SetNillableBeanID sets the "bean" edge to the Bean entity by ID if the given value is not nil.
func (puo *PostUpdateOne) SetNillableBeanID(id *int) *PostUpdateOne {
	if id != nil {
		puo = puo.SetBeanID(*id)
	}
	return puo
}

// SetBean sets the "bean" edge to the Bean entity.
func (puo *PostUpdateOne) SetBean(b *Bean) *PostUpdateOne {
	return puo.SetBeanID(b.ID)
}
...
// ClearBean clears the "bean" edge to the Bean entity.
func (puo *PostUpdateOne) ClearBean() *PostUpdateOne {
	puo.mutation.ClearBean()
	return puo
}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if nodes := puo.mutation.BeanIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   post.BeanTable,
